...
<!--Services-->
              ...
              <span v-show="!afterSubmit" class="total-pay">{{ totalPay | somma }}</span> 
                <form v-on:submit.prevent>
                 ...
                 <input @click="changeDate" type="text" style="z-index: 1003; display: block; opacity: 1; top: 4%; transform: scaleX(1) scaleY(1);" class="datepicker" v-model.lazy="Schedule" placeholder="Set A Date" required>
       ...
       if(this.validationDate == true & this.validationName == true & this.validationTime == true & this.validationService == true & this.validationNumber == true)
         {
           ...
           this.$http.post('https://salon-management-system-598d0.firebaseapp.com/jheny-app/appointments.json?',
           {
                      "type" : "appointment",
             ...
             {
                 this.$http.post('https://salon-management-system-598d0.firebaseapp.com/jheny-app/appointmentReadable.json',
                               {
                                          "date" : this.date,
                                          "time" : time,
                               }).then(function(data)
