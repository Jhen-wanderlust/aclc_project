    ...
    template : `<div :class="'animated fadeInRight component ' + id">
                  ...
                  <div class="col s12">
                    <div class="row">
                      ...
                      <div class="service-info"><input type="number" class="in" v-model="serv[3]" placeholder="Discount" required></div> 
                      <br>
                      ...
                      <div class="service-main-container" v-show="!open">
                        <div class="animated zoomIn main-service" v-for="cat in categories">
                          <h1 class="cat-title">{{ cat }}</h1>
                           ...
                           {{ service.name }} : php {{ service.price }} {{ service.discount }} 
        ...
        addService()
         {
            ...
            if(this.selected.length > 0 &  this.serv[1].length != 0  &  this.serv[2].length != 0 &  this.serv[3].length != 0)
              {
        
                    let cat = this.selected.toLowerCase().trim();             
                    this.$http.post('https://salon-management-system-598d0.firebaseio.com/jheny-app/services/.json?'+rest,
                                   {
                                    "category" : cat,
                                        "name" : this.serv[1],
                                       "price" : this.serv[2],
              ...
              if(confirmation == true)
               {
                 ...
                 this.$http.patch('https://salon-management-system-598d0.firebaseapp.com/jheny-app/services/'+key+'.json?'+rest,
                 {
