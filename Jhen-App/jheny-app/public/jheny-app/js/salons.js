          ...
          postSalons()
           {
            ...
            this.$http.post('https://salon-management-system-598d0.firebaseapp.com/salons.json',
             {
           ...
           getSalons()
           {
                this.$http.get('https://salon-management-system-598d0.firebaseapp.com/salons.json').then(function(data)
                {
