Vue.component('register',
{
    ...
    template : `<div :class="'animated zoomIn component '+id">
               <a @click="home" class="btn-floating btn-large waves-effect waves-light red"><i class="material-icons">home</i></a>
    ...
    methods : 
      {
        home(){
          window.location.href = 'https://reservation-system-69ff9.web.app/jheny-salon/website.html';
         },
          ...
          showOptions()
           ...
           terms(){
            ...
            swal("Terms and Condition!","When you use our services, you are trusting us with your information. We understand this is a big responsibility and work hard to protect your information and put you in control.");
