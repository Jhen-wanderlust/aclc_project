                  ...
                  <div class="col s12">
                    <div class="row">
                      <div class="input-field col s12">
                        ...
                        <label v-if="sentSuccess" id="valid" for="autocomplete-input">  {{selected}} is selected</label>
                      </div>
                    </div>
                  </div>
                 </div>
                      ...
                      <div class="service-info"><input  type="text" pattern="/^-?\d+\.?\d*$/"  :maxlength="pricemax" class="in" v-model="serv[2]" placeholder="Price of Service" required></div> 

                      <div class="service-info"><input  type="text" pattern="/^-\d+\.?\d*$/"  :maxlength = "discmax"  class="in" v-model="serv[3]" placeholder="Discount"></div> 
                      <br>
                      ...
                      <div class="service-main-container" v-show="!open">
                        <div class="animated zoomIn main-service" v-for="cat in categories">
                          <h1 class="cat-title">{{ cat }}</h1>
                           ...
                           {{ service.name }} : php {{ service.price }}  {{ service.discount }} {{ service.discount_symbol }}
                             ...
                             <ul>
                                ...
                                <li>
                                  <div class="focusable-test" tabindex="2" > 
                                  <input id="discount" style="text-align:center;background:rgba(0,0,0,0.7);color:white;"  rows="4" cols="50" v-model="service.discount">
                                  </div>
                                </li>  
            ...
            if(this.selected.length > 0 &  this.serv[1].length != 0  & this.serv[2].length != 0)
              {
                ...
                if(this.serv[3].length != 0  & this.serv[3] != "0" & this.serv[3] != " " & this.serv[3] != "  "){
